...
#define noexcept
#define constexpr
#define MSVC_STATIC_CONSTEXPR_DECL(a,b) static decltype(b) a
#define MSVC_STATIC_CONSTEXPR_DEFN(a,b) decltype(b) a = b
#else
#define MSVC_STATIC_CONSTEXPR_DECL(a,b) constexpr static decltype(b) a = b
#define MSVC_STATIC_CONSTEXPR_DEFN(a,b)
#endif
